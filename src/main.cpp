...
#define GFX_BL 32
Arduino_DataBus *bus = new Arduino_ESP32SPI(2 /* cs */, 15 /* sck */, 18 /* d0 */, 23,GFX_NOT_DEFINED);
Arduino_GFX *gfx = new Arduino_ILI9342(bus,4 /* width */, 4 /* height */);
#define CANVAS
...
//    //delay(1000);
    ...
    lv_obj_add_event_cb(objects.pwmpercent,event_handler,LV_EVENT_ALL,NULL);
    lv_obj_add_event_cb(objects.motor_st,event_handler,LV_EVENT_ALL,NULL);

    lv_timer_create(get_sw_state, 300, &SW1);
    lv_timer_create(update_adc34_meter, 200, NULL);
    lv_timer_create(update_adc33_meter, 100, NULL);
